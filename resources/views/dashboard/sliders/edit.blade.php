        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">تحديث شريط التمرير</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('sliders.index') }}">الصور</a></li>
                            <li class="breadcrumb-item active">تحديث شريط التمرير</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('sliders.update', $slider->id) }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <input type="text" name="title" class="form-control" id="title"
                                            value="{{ $slider->title }}" placeholder="أدخل عنوان شريط التمرير" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div>
                            ...
                            <div class="mt-4">
                                <button type="submit" class="btn btn-primary">تحديث شريط التمرير</button>
                            </div>
                        </form>
                    </div>
                </div>
