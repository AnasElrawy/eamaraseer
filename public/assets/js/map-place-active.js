$(function() {
    var LocsA = [{
            ...
            html: ['<div class="single-location bg-theme">',
                '<thumb class="thumb">',
                '<a href="#"><img src="assets/img/property/property_inner_1.jpg" alt="img"></a>',
                '<div class="property-card-tag">Residence</div>',
                '</thumb>',
                '<div class="media-body">',
                '<h4 class="title"><a href="#">Apartments Auckland</a></h4>',
                '<p class="price text-theme2">$895.00</p>',
                '<a class="location" href="#"><span class="icon"><img src="assets/img/icon/location-dot.svg" alt="img"></span>Brooklyn, New York 11233, United States</a>',
        ...
        },
        {
            ...
            html: ['<div class="single-location bg-theme">',
                '<thumb class="thumb">',
                '<a href="#"><img src="assets/img/property/property_inner_3.jpg" alt="img"></a>',
                '<div class="property-card-tag">Residence</div>',
                '</thumb>',
                '<div class="media-body">',
                '<h4 class="title"><a href="#">Serenity Villa</a></h4>',
                '<p class="price text-theme2">$895.00</p>',
                '<a class="location" href="#"><span class="icon"><img src="assets/img/icon/location-dot.svg" alt="img"></span>Brooklyn, New York 11233, United States</a>',
                '<div class="property-card-meta">',
                '<span><img src="assets/img/icon/property-icon1-1.svg" alt="img">Bed 4</span>',
        ...
        },
        {
            ...
            html: ['<div class="single-location bg-theme">',
                '<thumb class="thumb">',
                '<a href="#"><img src="assets/img/property/property_inner_7.jpg" alt="img"></a>',
                '<div class="property-card-tag">Residence</div>',
                '</thumb>',
                '<div class="media-body">',
                '<h4 class="title"><a href="#">Kledokan Residence</a></h4>',
                '<p class="price text-theme2">$895.00</p>',
                '<a class="location" href="#"><span class="icon"><img src="assets/img/icon/location-dot.svg" alt="img"></span>Brooklyn, New York 11233, United States</a>',
                '<div class="property-card-meta">',
                '<span><img src="assets/img/icon/property-icon1-1.svg" alt="img">Bed 4</span>',
        ...
        },
        {
            ...
            html: ['<div class="single-location bg-theme">',
                '<thumb class="thumb">',
                '<a href="#"><img src="assets/img/property/property_inner_4.jpg" alt="img"></a>',
                '<div class="property-card-tag">Residence</div>',
                '</thumb>',
                '<div class="media-body">',
                '<h4 class="title"><a href="#">Villa Berkel-Enschot</a></h4>',
                '<p class="price text-theme2">$895.00</p>',
                '<a class="location" href="#"><span class="icon"><img src="assets/img/icon/location-dot.svg" alt="img"></span>Brooklyn, New York 11233, United States</a>',
                '<div class="property-card-meta">',
                '<span><img src="assets/img/icon/property-icon1-1.svg" alt="img">Bed 4</span>',
        ...
        },
        {
            ...
            html: ['<div class="single-location bg-theme">',
                '<thumb class="thumb">',
                '<a href="#"><img src="assets/img/property/property_inner_6.jpg" alt="img"></a>',
                '<div class="property-card-tag">Residence</div>',
                '</thumb>',
                '<div class="media-body">',
                '<h4 class="title"><a href="#">Permai Residence</a></h4>',
                '<p class="price text-theme2">$895.00</p>',
                '<a class="location" href="#"><span class="icon"><img src="assets/img/icon/location-dot.svg" alt="img"></span>Brooklyn, New York 11233, United States</a>',
                '<div class="property-card-meta">',
                '<span><img src="assets/img/icon/property-icon1-1.svg" alt="img">Bed 4</span>',
