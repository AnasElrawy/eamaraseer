! function(t, n) {
    ...
    function E(t) {
        (!t.__d && (t.__d = !0) && h.push(t) && !I.__r++ || _ !== f.debounceRendering) && ((_ = f.debounceRendering) || setTimeout)(I)
    }

    function I() {
        for (var t; I.__r = h.length;) t = h.sort(function(t, n) {
            return t.__v.__b - n.__v.__b
        }), h = [], t.some(function(t) {
            var n, e, r, o, i, u;
            t.__d && (i = (o = (n = t).__v).__e, (u = n.__P) && (e = [], (r = b({}, o)).__v = o.__v + 1, M(u, o, r, n.__n, void 0 !== u.ownerSVGElement, null != o.__h ? [i] : null, e, null == i ? N(o) : i, o.__h), R(e, o), o.__e != i && C(o)))
        })
    }
    ...
    function T(t, n, e, r, o, i, u, s, a, l) {
        ...
        for (e.__k = [], c = 0; c < n.length; c++)
            if (null != (d = e.__k[c] = null == (d = n[c]) || "boolean" == typeof d ? null : "string" == typeof d || "number" == typeof d || "bigint" == typeof d ? k(null, d, null, null, d) : Array.isArray(d) ? k(P, {
                    children: d
                ...
                M(t, d, p = p || v, o, i, u, s, a, l), h = d.__e, (f = d.ref) && p.ref != f && (m || (m = []), p.ref && m.push(p.ref, null, d), m.push(f, d.__c || h, d)), null != h ? (null == _ && (_ = h), "function" == typeof d.type && d.__k === p.__k ? d.__d = a = L(d, a, t) : a = A(t, d, p, y, h, a), "function" == typeof e.type && (e.__d = a)) : a && p.__e == a && a.parentNode != t && (a = N(p))
            }
    ...
    function j(t, n, e, r, o) {
        ...
        t: if ("style" === n)
            if ("string" == typeof e) t.style.cssText = e;
                ...
                if (e)
                    for (n in e) r && e[n] === r[n] || O(t.style, n, e[n])
            }
        else if ("o" === n[0] && "n" === n[1]) i = n !== (n = n.replace(/Capture$/, "")), n = n.toLowerCase() in t ? n.toLowerCase().slice(2) : n.slice(2), t.l || (t.l = {}), t.l[n + i] = e, e ? r || t.addEventListener(n, i ? D : H, i) : t.removeEventListener(n, i ? D : H, i);
    ...
    function M(t, n, e, r, o, i, u, s, a) {
        var l, c, p, d, h, _, m, v, g, y, w, x, k, N, C, E = n.type;
        ...
        try {
            t: if ("function" == typeof E) {
                ...
                if (c.context = y, c.props = v, c.__v = n, c.__P = t, x = f.__r, k = 0, "prototype" in E && E.prototype.render) {
                    for (c.state = c.__s, c.__d = !1, x && x(n), l = c.render(c.props, c.state, c.context), N = 0; N < c._sb.length; N++) c.__h.push(c._sb[N]);
                    c._sb = []
                } else
                    do {
                        c.__d = !1, x && x(n), l = c.render(c.props, c.state, c.context), c.state = c.__s
                    } while (c.__d && ++k < 25);
                c.state = c.__s, null != c.getChildContext && (r = b(b({}, r), c.getChildContext())), p || null == c.getSnapshotBeforeUpdate || (_ = c.getSnapshotBeforeUpdate(d, h)), C = null != l && l.type === P && null == l.key ? l.props.children : l, T(t, Array.isArray(C) ? C : [C], n, e, r, o, i, u, s, a), c.base = n.__e, n.__h = null, c.__h.length && u.push(c), m && (c.__E = c.__ = null), c.__e = !1
    ...
    function F(t, n, e, r, o, i, u, s) {
        ...
        if (null === h) p === d || s && t.data === d || (t.data = d);
            ...
            else if (_ = n.props.children, T(t, Array.isArray(_) ? _ : [_], n, e, r, o && "foreignObject" !== h, i, u, i ? i[0] : e.__k && N(e, 0), s), null != i)
    ...
    function q(t, n, e) {
        var r, o, i;
        f.__ && f.__(t, n), o = (r = "function" == typeof e) ? null : e && e.__k || n.__k, i = [], M(n, t = (!r && e || n).__k = x(P, null, [t]), o || v, v, void 0 !== n.ownerSVGElement, !r && e ? [e] : o ? null : n.firstChild ? c.call(n.childNodes) : null, i, !r && e ? e : o ? o.__e : n.firstChild, r), R(i, t)
    }
    ...
    }, S.prototype.render = P, h = [], I.__r = 0, m = 0;
    ...
    function Y(t, n) {
        ...
        if (Array.isArray(t) && Array.isArray(n)) {
            ...
            for (var e = 0; e < t.length; e++)
                if (!Y(t[e], n[e])) return !1;
            return !0
        }
        if (t.hasOwnProperty("constructor") && n.hasOwnProperty("constructor") && t.hasOwnProperty("props") && n.hasOwnProperty("props") && t.hasOwnProperty("key") && n.hasOwnProperty("key") && t.hasOwnProperty("ref") && n.hasOwnProperty("ref") && t.hasOwnProperty("type") && n.hasOwnProperty("type")) return Y(t.props, n.props);
        var r = Object.keys(t),
            o = Object.keys(n);
    ...
    var tt = /*#__PURE__*/ function(t) {
            ...
            return i.process = function() {
                ...
                return Y(n, this._props) || (this._props = n, this.emit("propsUpdated", this)), this
            }, e(n, [{
                key: "props",
                get: function() {
                    return this._props
    ...
    var ot, it, ut, st, at = /*#__PURE__*/ function(t) {
            function n() {
                return t.apply(this, arguments) || this
            }
            return o(n, t), n.prototype._process = function(t) {
    ...
    function gt(t) {
        return lt = 1,
            function(t, n, e) {
                var r = vt(ot++, 2);
                if (r.t = t, !r.__c && (r.__ = [Et(void 0, n), function(t) {
    ...
    f.__b = function(t) {
        ...
        dt && dt(t), ot = 0;
        var n = (it = t.__c).__H;
        n && (ut === it ? (n.__h = [], it.__h = [], n.__.forEach(function(t) {
            t.__N && (t.__ = t.__N), t.__V = ft, t.__N = t.i = void 0
        })) : (n.__h.forEach(St), n.__h.forEach(Nt), n.__h = [])), ut = it
    }, f.diffed = function(t) {
        ht && ht(t);
        var n = t.__c;
        n && n.__H && (n.__H.__h.length && (1 !== ct.push(n) && st === f.requestAnimationFrame || ((st = f.requestAnimationFrame) || Pt)(xt)), n.__H.__.forEach(function(t) {
    ...
    function Dt() {
        ...
        yt(function() {
            ...
            if (e) return o.pipeline.register(e),
                function() {
        ...
        }, c = e instanceof at ? i.debounceTimeout || 250 : 0, function() {
            var t = arguments;
    ...
    function Ft() {
        var t = It(),
            ...
            N = At();
        yt(function() {
            return e ? (v.current = new Rt({
                    limit: p,
                    page: y,
                    url: e.url,
                    body: e.body
                }), t.pipeline.register(v.current)) : (v.current = new Mt({
                    limit: p,
                    page: y
                }), t.pipeline.register(v.current)), v.current instanceof Rt ? t.pipeline.on("afterProcess", function(t) {
                    return S(t.length)
                }) : v.current instanceof Mt && v.current.on("beforeProcess", function(t) {
                    return S(t.length)
                }), t.pipeline.on("updated", C), t.pipeline.on("error", function() {
                    S(0), b(0)
                }),
                function() {
        ...
        var C = function(t) {
                m && t !== v.current && (b(0), 0 !== v.current.props.page && v.current.setProps({
                    page: 0
                }))
            },
            E = function() {
        ...
        }, x(P, null, o && k > 0 && x("div", {
            role: "status",
            "aria-live": "polite",
            className: rt(et("summary"), t.className.paginationSummary),
            title: N("pagination.navigate", y + 1, E())
        }, N("pagination.showing"), " ", x("b", null, N("" + (y * p + 1))), " ", N("pagination.to"), " ", x("b", null, N("" + Math.min((y + 1) * p, k))), " ", N("pagination.of"), " ", x("b", null, N("" + k)), " ", N("pagination.results"))), x("div", {
            className: et("pages")
        }, a && x("button", {
            tabIndex: 0,
            role: "button",
        ...
        }, N("pagination.previous")), function() {
            if (c <= 0) return null;
            var n = Math.min(E(), c),
                e = Math.min(y, Math.floor(n / 2));
            return y + Math.floor(n / 2) >= E() && (e = n - (E() - y)), x(P, null, E() > n && y - e > 0 && x(P, null, x("button", {
                tabIndex: 0,
                role: "button",
                onClick: function() {
                    return I(0)
                ...
                return x("button", {
                    ...
                    className: rt(y === n ? rt(et("currentPage"), t.className.paginationButtonCurrent) : null, t.className.paginationButton),
                    title: N("pagination.page", n + 1),
                    "aria-label": N("pagination.page", n + 1)
                }, N("" + (n + 1)))
            }), E() > n && E() > y + e + 1 && x(P, null, x("button", {
                tabIndex: -1,
                className: rt(et("spread"), t.className.paginationButton)
            }, "..."), x("button", {
                tabIndex: 0,
    ...
    var zt, Vt = new( /*#__PURE__*/ function() {
        function t() {}
        var n = t.prototype;
    ...
    t.PluginPosition = void 0, (zt = t.PluginPosition || (t.PluginPosition = {}))[zt.Header = 0] = "Header", zt[zt.Footer = 1] = "Footer", zt[zt.Cell = 2] = "Cell";
    var $t = /*#__PURE__*/ function() {
        ...
        return n.get = function(t) {
            ...
            return t.id ? this.get(t.id) ? (Vt.error("Duplicate plugin ID: " + t.id), this) : (this.plugins.push(t), this) : (Vt.error("Plugin ID cannot be empty"), this)
        }, n.remove = function(t) {
            var n = this.get(t);
    ...
    function Gt(t) {
        ...
        if (t.pluginId) {
            ...
            return o ? x(P, {}, x(o.component, r({
                plugin: o
            }, t.props))) : null
        }
        return void 0 !== t.position ? x(P, {}, e.plugin.list(t.position).map(function(t) {
    ...
    var Kt = /*#__PURE__*/ function(n) {
            ...
            return u.adjustWidth = function(t, n, e) {
                ...
                n.current && u && (q(x(Bt, {
                    ...
                    var e = n.className,
                        o = n.style.cssText;
                    n.className = e + " " + et("shadowTable"), n.style.tableLayout = "auto", n.style.width = "auto", n.style.padding = "0", n.style.margin = "0", n.style.border = "none", n.style.outline = "none";
                ...
                for (var c, f = a(i.tabularFormat(this.columns).reduce(function(t, n) {
                    ...
                    var p = c.value;
                    p.columns && p.columns.length > 0 || (!p.width && u ? p.id in l && (p.width = Wt(l[p.id].width), p.minWidth = Wt(l[p.id].minWidth)) : p.width = Wt(Ut(p.width, s)))
                }
                ...
                for (var n, e = a(t || this.columns || []); !(n = e()).done;) {
                    var r = n.value;
                    r.id || "string" != typeof r.name || (r.id = qt(r.name)), r.id || Vt.error('Could not find a valid ID for one of the columns. Make sure a valid "id" is set for all columns.'), r.columns && this.setID(r.columns)
                }
        ...
        Jt = /*#__PURE__*/ function(t) {
            ...
            return e.handler = function(t) {
                return "function" == typeof this.options.handle ? this.options.handle(t) : t.ok ? t.json() : (Vt.error("Could not fetch data: " + t.status + " - " + t.statusText, !0), null)
            }, e.get = function(t) {
        ...
        Qt = /*#__PURE__*/ function() {
            ...
            return t.createFromConfig = function(t) {
                var n = null;
                return t.data && (n = new Zt(t.data)), t.from && (n = new Zt(this.tableElementToArray(t.from)), t.from.style.display = "none"), t.server && (n = new Jt(t.server)), n || Vt.error("Could not determine the storage type", !0), n
        ...
        Yt = "undefined" != typeof Symbol ? Symbol.iterator || (Symbol.iterator = Symbol("Symbol.iterator")) : "@@iterator";
    ...
    var rn = /*#__PURE__*/ function(t) {
            ...
            return r.clearCache = function() {
                ...
                if (this.findProcessorIndexByID(t.id) > -1) throw Error("Processor ID " + t.id + " is already defined");
                return t.on("propsUpdated", this.processorPropsUpdated.bind(this)), this.addProcessorByPriority(t, n), this.afterRegistered(t), t
                                                ...
                                                try {
                                                    for (; !(r = u.next()).done;)
                                                        if ((e = n(r.value)) && e.then) {
                                                            if (!en(e)) return void e.then(t, i || (i = tn.bind(null, o = new nn, 2)));
                                                            e = e.v
                                                        }
                                                    o ? tn(o, 1, e) : o = e
                                                } catch (t) {
                                    ...
                                    return function(t, n, e) {
                                        ...
                                        return function e(u) {
                                            try {
                                                for (; ++i < t.length;)
                                                    if ((u = n(i)) && u.then) {
                                                        if (!en(u)) return void u.then(e, o || (o = tn.bind(null, r = new nn, 2)));
                                                        u = u.v
                                                    }
                                                r ? tn(r, 1, u) : r = u
                                            } catch (t) {
            ...
            return r.castData = function(t) {
                ...
                return t[0] instanceof Array ? t.map(function(t) {
                    ...
                    return n.map(function(n, e) {
                        return void 0 !== n.data ? "function" == typeof n.data ? n.data(t) : n.data : n.id ? t[n.id] : (Vt.error("Could not find the correct cell for column at position " + e + ".\n                          Make sure either 'id' or 'selector' is defined for all columns."), null)
                    })
                })
            }, r._process = function(t) {
                return {
        ...
        ln = /*#__PURE__*/ function() {
            ...
            return t.createFromConfig = function(t) {
                var n = new rn;
                return t.storage instanceof Jt && n.register(new sn({
        ...
        pn = /*#__PURE__*/ function() {
            ...
            return e.assign = function(t) {
                ...
                return "boolean" == typeof e.sort && e.sort && r.assign({
                    ...
                    header: Kt.createFromConfig(r)
                }), r.assign({
                    storage: Qt.createFromConfig(r)
                }), r.assign({
                    pipeline: ln.createFromConfig(r)
                }), r.assign({
                    translator: new Lt(r.language)
                }), r.plugin = new $t, r.search && r.plugin.add({
                    id: "search",
    ...
    function dn(t) {
        ...
        }, (n = t.column) ? "function" == typeof n.attributes ? n.attributes(t.cell.data, t.row, t.column) : n.attributes : {}), t.column && "function" == typeof t.column.formatter ? t.column.formatter(t.cell.data, t.row, t.column) : t.column && t.column.plugin ? x(Gt, {
    ...
    function mn() {
        ...
        }), e === l.Loading && (!n || 0 === n.length) && x(_n, {
            message: o("loading"),
            colSpan: i(),
            className: rt(et("loading"), t.className.loading)
        }), e === l.Rendered && n && 0 === n.length && x(_n, {
    ...
    var vn = /*#__PURE__*/ function(t) {
            ...
            return r.validateProps = function() {
                for (var t, n = a(this.props.columns); !(t = n()).done;) {
                    var e = t.value;
                    void 0 === e.direction && (e.direction = 1), 1 !== e.direction && -1 !== e.direction && Vt.error("Invalid sort direction " + e.direction)
                }
        ...
        gn = function(t, n, e, o) {
            return function(i) {
                var u, s = null != (u = i.sort) && u.columns ? i.sort.columns.map(function(t) {
                        return r({}, t)
                    }) : [],
                    a = s.length,
                    l = s.find(function(n) {
                    ...
                    p = !1,
                    d = !1;
                if (void 0 !== l ? e ? -1 === l.direction ? p = !0 : d = !0 : 1 === a ? d = !0 : a > 1 && (f = !0, c = !0) : 0 === a ? c = !0 : a > 0 && !e ? (c = !0, f = !0) : a > 0 && e && (c = !0), f && (s = []), c) s.push({
                    index: t,
                    direction: n,
                    compare: o
                });
        ...
        yn = function(t, n, e) {
            return function(o) {
                ...
                return r({}, o, i ? gn(t, 1 === i.direction ? -1 : 1, n, e)(o) : gn(t, 1, n, e)(o))
            }
        },
    ...
    function wn(t) {
        ...
        return yt(function() {
            var t = f() || (c === K.ServerSort ? new bn(r({
                columns: l ? l.columns : []
            }, a.server)) : new vn({
                columns: l ? l.columns : []
            }));
            return n.pipeline.tryRegister(t),
                function() {
                    return n.pipeline.unregister(t)
                }
        }, [n]), yt(function() {
            if (l) {
                var n, e = l.columns.find(function(n) {
                    return n.index === t.index
                });
                e ? (0 === u && (e.direction = null != (n = t.direction) ? n : 1), s(e.direction)) : s(0)
            }
        }, [l]), yt(function() {
            var t = f();
            t && l && t.setProps({
            ...
            className: rt(et("sort"), et("sort", function(t) {
                return 1 === t ? "asc" : -1 === t ? "desc" : "neutral"
            }(u)), n.className.sort),
            onClick: function(n) {
                n.preventDefault(), n.stopPropagation(), e(yn(t.index, !0 === n.shiftKey && a.multiColumn, t.compare))
            }
        })
    }
    var xn = function(t, n) {
        ...
        return function() {
            var t = [].slice.call(arguments),
                i = Date.now(),
                u = i - r;
            u >= n ? o.apply(void 0, t) : (e && clearTimeout(e), e = setTimeout(function() {
    ...
    function kn(t) {
        var n, e = function(t) {
            ...
            r = function(r) {
                ...
                n = xn(function(t) {
                    return o(t, u)
                }, 10), document.addEventListener("mouseup", i), document.addEventListener("touchend", i), document.addEventListener("mousemove", n), document.addEventListener("touchmove", n)
            },
            o = function(n, r) {
                n.stopPropagation();
    ...
    function Pn(t) {
        ...
        var a, l = function() {
            ...
            c = function(e) {
                e.stopPropagation(), l() && s(yn(t.index, !0 === e.shiftKey && n.sort.multiColumn, t.column.sort.compare))
            };
        return x("th", r({
            ref: e,
            "data-column-id": t.column && t.column.id,
            className: rt(et("th"), l() ? et("th", "sort") : null, n.fixedHeader ? et("th", "fixed") : null, n.className.th),
            onClick: c,
            style: r({}, n.style.th, {
        ...
        }, void 0 !== t.column.name ? t.column.name : void 0 !== t.column.plugin ? x(Gt, {
            ...
            index: t.index
        }, t.column.sort)), t.column.resizable && t.index < n.header.visibleColumns.length - 1 && x(kn, {
            column: t.column,
            thRef: e
        }))
    }
    ...
    function Tn() {
        ...
        return yt(function() {
            return n(Nn(t.header)), s(), t.pipeline.on("updated", s),
                function() {
                    return t.pipeline.off("updated", s)
                }
        }, []), yt(function() {
            t.header && e === l.Loaded && null != o && o.length && n(Nn(t.header.adjustWidth(t, i, u)))
        }, [o, t, u]), x("div", {
            role: "complementary",
            className: rt("gridjs", et("container"), e === l.Loading ? et("loading") : null, t.className.container),
    ...
    var Ln = /*#__PURE__*/ function(t) {
        function n(n) {
            var e;
            return (e = t.call(this) || this).config = void 0, e.plugin = void 0, e.config = (new pn).assign({
                instance: u(e),
                eventEmitter: u(e)
        ...
        return e.updateConfig = function(t) {
            ...
            return x(fn.Provider, {
                value: this.config,
                children: x(Tn, {})
            })
        }, e.forceRender = function() {
            return this.config && this.config.container || Vt.error("Container is empty. Make sure you call render() before forceRender()", !0), this.destroy(), q(this.createElement(), this.config.container), this
        }, e.destroy = function() {
            this.config.pipeline.clearCache(), q(null, this.config.container)
        }, e.render = function(t) {
            return t || Vt.error("Container element cannot be null", !0), t.childNodes.length > 0 ? (Vt.error("The container element " + t + " is not empty. Make sure the container is empty and call render() again"), this) : (this.config.container = t, q(this.createElement(), t), this)
        }, n
    }(Q);
    t.Cell = X, t.Component = S, t.Config = pn, t.Grid = Ln, t.Row = Z, t.className = et, t.createElement = x, t.createRef = function() {
        return {
            current: null
        }
    }, t.h = x, t.html = G, t.useConfig = It, t.useEffect = yt, t.useRef = bt, t.useSelector = Ht, t.useState = gt, t.useStore = jt, t.useTranslator = At
});
