...
var FullCalendar = function(e) {
    ...
    function E(e, t, n, r, i) {
        ...
        e: if ("style" === t)
            if ("string" == typeof n) e.style.cssText = n;
                ...
                if (n)
                    for (t in n) r && n[t] === r[t] || b(e.style, t, n[t])
            }
        else if ("o" === t[0] && "n" === t[1]) s = t !== (t = t.replace(/Capture$/, "")), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + s] = n, n ? r || e.addEventListener(t, s ? A : S, s) : e.removeEventListener(t, s ? A : S, s);
    ...
    function T(e, t, n, r, i, s, o, a, l, c) {
        ...
        if (E)
            for (h = 0; h < E.length; h++) B(E[h], E[++h], E[++h])
    }
    ...
    function N(e, t, r, i, s, o, a, l, c) {
        ...
        try {
            e: if ("function" == typeof _) {
                if (b = t.props, E = (d = _.contextType) && i[d.__c], S = d ? E ? E.props.value : d.__ : i, r.__c ? v = (u = t.__c = r.__c).__ = u.__E : ("prototype" in _ && _.prototype.render ? t.__c = u = new _(b, S) : (t.__c = u = new D(b, S), u.constructor = _, u.render = z), E && E.sub(u), u.props = b, u.state || (u.state = {}), u.context = S, u.__n = i, h = u.__d = !0, u.__h = [], u._sb = []), null == u.__s && (u.__s = u.state), null != _.getDerivedStateFromProps && (u.__s == u.state && (u.__s = f({}, u.__s)), f(u.__s, _.getDerivedStateFromProps(b, u.__s))), g = u.props, p = u.state, u.__v = t, h) null == _.getDerivedStateFromProps && null != u.componentWillMount && u.componentWillMount(), null != u.componentDidMount && u.__h.push(u.componentDidMount);
                else {
    ...
    function H(e, n, r, i, s, o, a, l) {
        ...
        if (null === m) f === p || l && e.data === p || (e.data = p);
            ...
            else if (v = n.props.children, T(e, Array.isArray(v) ? v : [v], n, r, i, s && "foreignObject" !== m, o, a, o ? o[0] : r.__k && w(r, 0), l), null != o)
    ...
    function j(e, t, r) {
        ...
        if (i = e.__k)
            for (s = 0; s < i.length; s++) i[s] && j(i[s], t, r || "function" != typeof e.type);
    ...
    function Cn(e, t) {
        if (e === t) return !0;
        for (let n in e)
            if (bn.call(e, n) && !(n in t)) return !1;
        for (let n in t)
            if (bn.call(t, n) && e[n] !== t[n]) return !1;
        return !0
    }
    const Rn = /^on[A-Z]/;
    ...
    function _n(e, t, n = {}) {
        if (e === t) return !0;
        for (let r in t)
            if (!(r in e) || !Tn(e[r], t[r], n[r])) return !1;
        for (let n in e)
            if (!(n in t)) return !1;
        return !0
    }
    ...
    function Fr(e, t, n) {
        let {
            defs: r
        } = e, i = An(e.instances, e => r[e.defId].allDay ? e : Object.assign(Object.assign({}, e), {
            range: {
    ...
    class ti {
        ...
        setProp(e, t) {
            ...
            else if ("id" === e) t = yr[e](t), this.mutate({
                standardProps: {
                    publicId: t
                }
            });
        ...
        formatRange(e) {
            let {
                dateEnv: t
            } = this._context, n = this._instance, r = an(e);
    ...
    function Si(e, t, n) {
        let r = function(e, t) {
                let {
                    refined: n,
                    extra: r
                } = vn(e, Ei), i = n.start ? t.createMarkerMeta(n.start) : null, s = n.end ? t.createMarkerMeta(n.end) : null, {
                    allDay: o
                } = n;
    ...
    class Ni {
        ...
        getEventSourceById(e) {
            ...
            e = String(e);
            for (let r in n)
                if (n[r].publicId === e) return new ei(t, n[r]);
            return null
        }
        addEventSource(e) {
            let t = this.getCurrentData();
    ...
    class cs {
        ...
        insertEntryAt(e, t) {
            let {
                entriesByLevel: n,
                levelCoords: r
            } = this; - 1 === t.lateral ? (gs(r, t.level, t.levelCoord), gs(n, t.level, [e])) : gs(n[t.level], t.lateral, e), this.stackCnts[us(e)] = t.stackCnt
        }
        findInsertion(e) {
            let {
                levelCoords: t,
    ...
    class Ds extends Gn {
        render() {
            let {
                ...
                date: s,
                dateProfile: o
            } = i, a = Fi(s, i.todayRange, null, o), l = [Ss].concat(Vi(a, n)), c = e.format(s, i.dayHeaderFormat), d = !a.isDisabled && i.colCnt > 1 ? qi(this.context, s) : {}, u = Object.assign(Object.assign(Object.assign({
                date: e.toDate(s),
                view: r
            }, i.extraRenderProps), {
                text: c
    ...
    class Cs extends Gn {
        render() {
            let {
                ...
                viewApi: r,
                options: i
            } = this.context, s = wt(new Date(2592e5), e.dow), o = {
                dow: e.dow,
                isDisabled: !1,
                isFuture: !1,
                isPast: !1,
    ...
    class Rs extends D {
        ...
        computeTiming() {
            let {
                props: e,
                context: t
            } = this, n = Ct(this.initialNowDate, (new Date).valueOf() - this.initialNowQueriedMs), r = t.dateEnv.startOf(n, e.unit), i = t.dateEnv.add(r, ft(1, e.unit)), s = i.valueOf() - n.valueOf();
    ...
    class ks {
        ...
        getDateDayIndex(e) {
            let {
                indices: t
            } = this, n = Math.floor(xt(this.dates[0], e));
    ...
    function Ns(e, t, n) {
        ...
        for (let e in r)
            if (!ar(t.validRange, r[e].range)) return !1;
        return Hs({
            eventDrag: e
        }, n)
    }
    ...
    class io extends Gn {
        ...
        render() {
            let {
                ...
                state: t,
                context: n
            } = this, r = e.sections || [], i = this.processCols(e.cols), s = this.renderMicroColGroup(i, t.shrinkWidth), o = Ks(e.liquid, n);
        ...
        renderChunkTd(e, t, n, r) {
            ...
            } = this.state, l = qs(i, e), c = Qs(i, e), d = i.liquid ? s ? "scroll" : l ? "auto" : "hidden" : "visible", u = e.key, h = Ys(e, n, {
                tableColGroupNode: t,
                tableMinWidth: "",
    ...
    class oo extends Gn {
        render() {
            let {
                ...
                ui: i
            } = r.eventRange, s = pi(r, n.eventTimeFormat || e.defaultTimeFormat, t, e.defaultDisplayEventTime, e.defaultDisplayEventEnd);
    ...
    function fo(e) {
        let {
            ...
            dateProfile: r,
            isMonthStart: i
        } = e, s = Fi(t, e.todayRange, null, r), o = e.showDayNumber ? n.format(t, i ? e.monthStartFormat : co) : "";
        ...
        render() {
            ...
            return p(Ln.Consumer, null, n => {
                let {
                    ...
                    moreCnt: a
                } = e, l = Do(e), c = "function" == typeof o ? o.call(s, a) : `+${a} ${o}`, d = at(i.moreLinkHint, [a], c), u = {
                    num: a,
                    shortText: "+" + a,
                    text: c,
                    view: r
    ...
    function $o(e, t, n, r) {
        let {
            options: i,
            calendarApi: s
        } = r, o = r.pluginHooks.eventSourceDefs[e.sourceDefId], a = Ze();
        return o.fetch({
            eventSource: e,
            range: t,
            isRefetch: n,
    ...
    const ca = [Po({
        ...
        eventSourceDefs: [{
            ...
            fetch(e, t, n) {
                ...
                Ci(e.eventSource.meta.bind(null, Di(e.range, r)), e => t({
                    rawEvents: e
                }), n)
            }
        }]
    ...
    class ha {
        ...
        processRawCalendarOptions(e, t) {
            let {
                locales: n,
                locale: r
            } = mn([cn, e, t]), i = this.organizeRawLocales(n), s = i.map, o = this.buildLocale(r || i.defaultCode, s).options, a = this.buildPluginHooks(e.plugins || [], ca), l = this.currentCalendarOptionsRefiners = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, ln), dn), un), a.listenerRefiners), a.optionRefiners), c = {}, d = mn([cn, o, e, t]), u = {}, h = this.currentCalendarOptionsInput, f = this.currentCalendarOptionsRefined, g = !1;
    ...
    class _a extends Vn {
        constructor() {
            super(...arguments), this.buildViewContext = Gt(Fn), this.buildViewPropTransformers = Gt(ka), this.buildToolbarProps = Gt(Ta), this.headerRef = {
                current: null
            }, this.footerRef = {
                current: null
    ...
    class Ba {
        ...
        getMirrorEl() {
            let e = this.sourceElRect,
                t = this.mirrorEl;
            return t || (t = this.mirrorEl = this.sourceEl.cloneNode(!0), t.style.userSelect = "none", t.style.webkitUserSelect = "none", t.style.pointerEvents = "none", t.classList.add("fc-event-dragging"), Be(t, {
                position: "fixed",
                zIndex: this.zIndex,
                visibility: "",
            ...
            for (let s in n) {
                ...
                if (a && a.isWithinClipping(e, t)) {
                    ...
                    if (l >= 0 && l < u && c >= 0 && c < h) {
                        ...
                        e && ar(e.dateProfile.activeRange, e.dateSpan.range) && (this.disablePointCheck || a.el.contains(a.el.getRootNode().elementFromPoint(l + n - window.scrollX, c + r - window.scrollY))) && (!i || e.layer > i.layer) && (e.componentId = s, e.context = o.context, e.rect.left += n, e.rect.right += n, e.rect.top += r, e.rect.bottom += r, i = e)
                    }
                }
            }
            return i
    ...
    class Za extends Mi {
        constructor(e) {
            super(e), this.subjectEl = null, this.subjectSeg = null, this.isDragging = !1, this.eventRange = null, this.relevantEvents = null, this.receivingContext = null, this.validMutation = null, this.mutatedRelevantEvents = null, this.handlePointerDown = e => {
                ...
                if (e) {
                    ...
                    i === s || t.editable && t.droppable ? (o = function(e, t, n, r) {
                        ...
                        return d
                    }(r, e, this.eventRange.instance.range.start, s.getCurrentData().pluginHooks.eventDragMutationMassagers), o && (a = $r(n, s.getCurrentData().eventUiBases, o, s), c.mutatedEvents = a, Ns(c, e.dateProfile, s) || (l = !0, o = null, a = null, c.mutatedEvents = {
                        defs: {},
                        instances: {}
                    }))) : s = null
                }
            ...
            let {
                ...
                options: n
            } = t.context, r = this.dragging = new Fa(e.el);
            ...
            this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = e => {
                ...
                e && (i = e.context, this.canDropElOnCalendar(n.subjectEl, i) && (s = function(e, t, n) {
                    ...
                    let {
                        refined: i,
                        extra: s
                    } = Ar(r, n), o = wr(i, s, t.sourceId, e.allDay, n.options.forceEventDuration || Boolean(t.duration), n), a = e.range.start;
    ...
    var el = Po({
        ...
        componentInteractions: [class extends Mi {
            constructor(e) {
                super(e), this.handlePointerDown = e => {
                    ...
                    if (!n.wasTouchScroll) {
                        ...
                        if (n && r && qa(n, r)) {
                            let {
                                context: r
                            } = t, i = Object.assign(Object.assign({}, Ya(n.dateSpan, r)), {
                                dayEl: n.dayEl,
                                jsEvent: e.origEvent,
            ...
            constructor(e) {
                super(e), this.draggingSegEl = null, this.draggingSeg = null, this.eventRange = null, this.relevantEvents = null, this.validMutation = null, this.mutatedRelevantEvents = null, this.handlePointerDown = e => {
                    let {
                        component: t
                    } = this, n = ai(this.querySegEl(e)), r = this.eventRange = n.eventRange;
                    ...
                    }), c ? Xe() : $e(), t || (a && qa(s, e) && (a = null), this.validMutation = a, this.mutatedRelevantEvents = l)
                }, this.handleDragEnd = e => {
                    let {
                        context: t
                    } = this.component, n = this.eventRange.def, r = this.eventRange.instance, i = new ti(t, n, r), s = this.relevantEvents, o = this.mutatedRelevantEvents;
    ...
    class tl extends ls {
        ...
        renderHScrollLayout(e, t, n, r) {
            ...
            let {
                props: s,
                context: o
            } = this, a = !s.forPrint && no(o.options), l = !s.forPrint && ro(o.options), c = [];
            return e && c.push({
                type: "header",
                key: "header",
                isSticky: a,
    ...
    class ll extends Gn {
        render() {
            let {
                ...
                seg: r
            } = e, i = pi(r, n.eventTimeFormat || sl, t, !0, e.defaultDisplayEventEnd);
            return p(so, Object.assign({}, e, {
                elTag: "a",
    ...
    class fl extends ls {
        ...
        render() {
            ...
            const l = t.showDayNumber && function(e, t, n) {
                ...
                } = t, s = Ct(i, -1), o = n.getYear(r), a = n.getMonth(r), l = n.getYear(s), c = n.getMonth(s);
    ...
    class El extends ls {
        constructor() {
            super(...arguments), this.cellElRefs = new Vs, this.frameElRefs = new Vs, this.fgElRefs = new Vs, this.segHarnessRefs = new Vs, this.rootElRef = {
                current: null
            }, this.state = {
                framePositions: null,
        ...
        render() {
            let {
                ...
                options: r
            } = n, i = e.cells.length, s = rl(e.businessHourSegs, i), o = rl(e.bgEventSegs, i), a = rl(this.getHighlightSegs(), i), l = rl(this.getMirrorSegs(), i), {
                singleColPlacements: c,
                multiColPlacements: d,
                moreCnts: u,
                moreMarginTops: h
            } = vl(di(e.fgEventSegs, r.eventOrder), e.dayMaxEvents, e.dayMaxEventRows, r.eventOrderStrict, t.segHeights, t.maxContentHeight, e.cells), f = e.eventDrag && e.eventDrag.affectedInstances || e.eventResize && e.eventResize.affectedInstances || {};
            return p("tr", {
                ref: this.rootElRef,
                role: "row"
            ...
            if (c)
                for (let e of t) {
                    let {
                        ...
                        instanceId: f
                    } = t.eventRange.instance, g = e.isVisible && !r[f], m = e.isAbsolute, v = "", y = "";
    ...
    class Sl extends ls {
        constructor() {
            super(...arguments), this.splitBusinessHourSegs = Gt(nl), this.splitBgEventSegs = Gt(nl), this.splitFgEventSegs = Gt(nl), this.splitDateSelectionSegs = Gt(nl), this.splitEventDrag = Gt(il), this.splitEventResize = Gt(il), this.rowRefs = new Vs
        }
        render() {
            let {
                props: e,
    ...
    class Cl extends ls {
        constructor() {
            super(...arguments), this.slicer = new wl, this.tableRef = {
                current: null
            }
        }
        render() {
        ...
        views: {
            dayGrid: {
                component: class extends tl {
                    constructor() {
                        super(...arguments), this.buildDayTableModel = Gt(Rl), this.headerRef = {
                            current: null
                        }, this.tableRef = {
                            current: null
                        }
                    ...
                    render() {
                        let {
                            ...
                            props: n
                        } = this, r = this.buildDayTableModel(n.dateProfile, t), i = e.dayHeaders && p(_s, {
                            ref: this.headerRef,
    ...
    function Il(e) {
        ...
        return p(Ln.Consumer, null, n => {
            ...
            let {
                ...
                options: i,
                viewApi: s
            } = n, o = null == i.slotLabelFormat ? Ml : Array.isArray(i.slotLabelFormat) ? an(i.slotLabelFormat[0]) : an(i.slotLabelFormat), a = {
                level: 0,
                time: e.time,
    ...
    class Hl extends ls {
        constructor() {
            super(...arguments), this.allDaySplitter = new kl, this.headerElRef = {
                current: null
            }, this.rootElRef = {
                current: null
            }, this.scrollerElRef = {
                ...
                let {
                    ...
                    dateProfile: r
                } = this.props, i = r.renderRange, s = 1 === xt(i.start, i.end) ? qi(this.context, i.start, "week") : {};
        ...
        renderHScrollLayout(e, t, n, r, i, s, o) {
            ...
            let {
                context: l,
                props: c
            } = this, d = !c.forPrint && no(l.options), u = !c.forPrint && ro(l.options), h = [];
            e && h.push({
                type: "header",
                key: "header",
                isSticky: d,
    ...
    class Kl extends Gn {
        ...
        render() {
            ...
            return p(uo, {
                ...
                className: "fc-timegrid-now-indicator-container"
            }, this.renderNowIndicator(e.nowIndicatorSegs)), ho(n) && p(t, {
                elTag: "div",
        ...
        renderPositionedFgSegs(e, t, n, r, i, s) {
            ...
            return p(y, null, this.renderHiddenGroups(E, e), b.map(e => {
                let {
                    seg: o,
                    rect: l
                } = e, c = o.eventRange.instance.instanceId, d = m || Boolean(!t[c] && l), u = tc(l && l.span), v = !m && l ? this.computeSegHStyle(l) : {
                    left: 0,
                    right: 0
        ...
        renderFillSegs(e, t) {
            let {
                props: n,
                context: r
            } = this, i = Xl(e, n.date, n.slatCoords, r.options.eventMinHeight).map((r, i) => {
                let s = e[i];
                return p("div", {
                    key: yi(s.eventRange),
    ...
    class nc extends Gn {
        constructor() {
            super(...arguments), this.splitFgEventSegs = Gt(Wl), this.splitBgEventSegs = Gt(Wl), this.splitBusinessHourSegs = Gt(Wl), this.splitNowIndicatorSegs = Gt(Wl), this.splitDateSelectionSegs = Gt(Wl), this.splitEventDrag = Gt(Ll), this.splitEventResize = Gt(Ll), this.rootElRef = {
                current: null
    ...
    class rc extends ls {
        constructor() {
            super(...arguments), this.processSlotOptions = Gt(ic), this.state = {
                slatCoords: null
            }, this.handleRootEl = e => {
    ...
    class oc extends ls {
        constructor() {
            super(...arguments), this.buildDayRanges = Gt(ac), this.slicer = new sc, this.timeColsRef = {
                current: null
            }
        }
        render() {
    ...
    class hc extends Gn {
        ...
        render() {
            let {
                ...
                textId: a
            } = this.state, l = Fi(s, o), c = n.listDayFormat ? t.format(s, n.listDayFormat) : "", d = n.listDaySideFormat ? t.format(s, n.listDaySideFormat) : "", u = Object.assign({
                date: t.toDate(s),
                view: r,
                textId: a,
                text: c,
    ...
    class Sc extends ls {
        constructor() {
            super(...arguments), this.buildDayTableModel = Gt(Rl), this.slicer = new wl, this.state = {
                labelId: We()
            }
        }
        render() {
    ...
    var _c = Po({
        ...
        views: {
            multiMonth: {
                component: class extends ls {
                    constructor() {
                        super(...arguments), this.splitDateProfileByMonth = Gt(Dc), this.buildMonthFormat = Gt(Rc), this.scrollElRef = {
                            current: null
                    ...
                    flushScrollReset() {
                        if (this.needsScrollReset && null != this.state.monthHPadding) {
                            const {
                                currentDate: e
                            } = this.props.dateProfile, t = this.scrollElRef.current, n = t.querySelector(`[data-date="${Lt(e)}"]`);
    ...
    return ca.push(el, Tl, uc, Ec, _c), e.Calendar = class extends Ni {
                    ...
                    if (this.isRendering) {
                        ...
                        jn(() => {
                            U(p(ki, {
                                ...
                                theme: e.theme,
                                emitter: e.emitter
                            }, (t, n, r, i) => (this.setClassNames(t), this.setHeight(n), p($n.Provider, {
        ...
        constructor(e, t) {
            ...
            "string" == typeof t.itemSelector ? r.pointer.selector = t.itemSelector : n === document && (r.pointer.selector = "[data-event]"), "string" == typeof t.mirrorSelector && (r.mirrorSelector = t.mirrorSelector), new Ja(r, t.eventData).hitDragging.disablePointCheck = !0
        }
        destroy() {
            this.dragging.destroy()
        }
    ...
    }, e.version = "6.1.15", Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});