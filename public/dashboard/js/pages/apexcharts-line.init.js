...
function loadCharts() {
    (g = getChartColorsArray("line_chart_basic")) && (y = {
        series: [{
            name: "Desktops",
    ...
    }, "" != linechartBasicChart && linechartBasicChart.destroy(), (linechartBasicChart = new ApexCharts(document.querySelector("#line_chart_basic"), y)).render()), (g = getChartColorsArray("line_chart_zoomable")) && (y = {
        series: [{
            name: "XYZ MOTORS",
            data: [{
    ...
    }, "" != linechartZoomChart && linechartZoomChart.destroy(), (linechartZoomChart = new ApexCharts(document.querySelector("#line_chart_zoomable"), y)).render()), (g = getChartColorsArray("line_chart_datalabel")) && (y = {
        chart: {
            height: 380,
            type: "line",
            zoom: {
    ...
    }, "" != linechartDatalabelChart && linechartDatalabelChart.destroy(), (linechartDatalabelChart = new ApexCharts(document.querySelector("#line_chart_datalabel"), y)).render()), (g = getChartColorsArray("line_chart_dashed")) && (y = {
        chart: {
            height: 380,
            type: "line",
            zoom: {
    ...
    }, "" != linechartDashedChart && linechartDashedChart.destroy(), (linechartDashedChart = new ApexCharts(document.querySelector("#line_chart_dashed"), y)).render());
    (linechartannotationsColors = getChartColorsArray("line_chart_annotations")) && (y = {
        series: [{
    ...
    }, "" != linechartannotationsChart && linechartannotationsChart.destroy(), (linechartannotationsChart = new ApexCharts(document.querySelector("#line_chart_annotations"), y)).render());
    var r = function(e, t, a) {
        ...
        n = ((g = getChartColorsArray("brushchart_line2")) && (y = {
            series: [{
                data: r
            }],
            chart: {
        ...
        }, "" != brushchartLine2Chart && brushchartLine2Chart.destroy(), (brushchartLine2Chart = new ApexCharts(document.querySelector("#brushchart_line2"), y)).render()), (g = getChartColorsArray("brushchart_line")) && (c = {
            series: [{
                data: r
            }],
            chart: {
        ...
        }, "" != brushchartLineChart && brushchartLineChart.destroy(), (brushchartLineChart = new ApexCharts(document.querySelector("#brushchart_line"), c)).render()), (g = getChartColorsArray("line_chart_stepline")) && (y = {
            series: [{
            ...
            colors: g
        }, "" != steplineChartChart && steplineChartChart.destroy(), (steplineChartChart = new ApexCharts(document.querySelector("#line_chart_stepline"), y)).render()), (g = getChartColorsArray("line_chart_gradient")) && (y = {
            series: [{
                name: "Likes",
        ...
        }, "" != lineChartGradientChart && lineChartGradientChart.destroy(), (lineChartGradientChart = new ApexCharts(document.querySelector("#line_chart_gradient"), y)).render()), (g = getChartColorsArray("line_chart_missing_data")) && (y = {
            series: [{
                name: "Peter",
            ...
            xaxis: {},
            colors: g
        }, "" != linechartMissingDataChart && linechartMissingDataChart.destroy(), (linechartMissingDataChart = new ApexCharts(document.querySelector("#line_chart_missing_data"), y)).render()), 0),
        r = [],
        i = 864e5,
        o = 7776e5;
    for (var e = new Date("11 Feb 2017 GMT").getTime(), t = 10, a = {
            min: 10,
            max: 90
        }, l = 0; l < t;) {
        var s = e,
    ...
    function m(e, t, a) {
        ...
        return n
    }(g = getChartColorsArray("line_chart_realtime")) && (y = {
        series: [{
            data: r.slice()
        }],
        chart: {
    ...
    }, "" != linechartrealtimeChart && linechartrealtimeChart.destroy(), (linechartrealtimeChart = new ApexCharts(document.querySelector("#line_chart_realtime"), y)).render()), window.setInterval(function() {
        var e = {
                min: 10,
                max: 90
            },
            t = n + i;
        n = t;
        for (var a = 0; a < r.length - 10; a++) r[a].x = t - o - i, r[a].y = 0;
        r.push({
            x: t,
    ...
    var g, y, c;
    (g = getChartColorsArray("chart-syncing-line")) && (c = {
        series: [{
    ...
    }, "" != chartSyncingLineChart && chartSyncingLineChart.destroy(), (chartSyncingLineChart = new ApexCharts(document.querySelector("#chart-syncing-line"), c)).render()), (y = getChartColorsArray("chart-syncing-line2")) && (g = {
        series: [{
            data: m(new Date("11 Feb 2017").getTime(), 20, {
                min: 10,
                max: 30
    ...
    }, "" != chartSyncingLine2Chart && chartSyncingLine2Chart.destroy(), (chartSyncingLine2Chart = new ApexCharts(document.querySelector("#chart-syncing-line2"), g)).render());
    (c = getChartColorsArray("chart-syncing-area")) && (y = {
        series: [{
            data: m(new Date("11 Feb 2017").getTime(), 20, {
                min: 10,
                max: 60
    ...
    }, "" != chartSyncingAreaChart && chartSyncingAreaChart.destroy(), (chartSyncingAreaChart = new ApexCharts(document.querySelector("#chart-syncing-area"), y)).render())
}
