...
function loadCharts() {
    var e = getChartColorsArray("world-map-line-markers"),
        e = (e && (document.getElementById("world-map-line-markers").innerHTML = "", new jsVectorMap({
            map: "world_merc",
        ...
        e = (e && (document.getElementById("world-map-markers").innerHTML = "", new jsVectorMap({
            map: "world_merc",
    ...
    e && (document.getElementById("world-map-markers-image").innerHTML = "", new jsVectorMap({
        map: "world_merc",
