const Portlet = function() {
    const a = document.querySelector('.card a[data-toggle="reload"]');
    a && a.addEventListener("click", function(e) {
        e.preventDefault();
        e = a.closest(".card");
        e.children[1].insertAdjacentHTML("beforeend", `
            ...
            `);
        const t = e.querySelector(".card-preloader");
        setTimeout(function() {
            t && t.remove()
...
var growingLoader = function() {
        var a = document.querySelector('.card a[data-toggle="growing-reload"]');
        a && a.addEventListener("click", function(e) {
            e.preventDefault();
