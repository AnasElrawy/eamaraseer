!(function () {
    ...
    function h(e) {
        if (document.getElementById("header-lang-img")) {
            switch (e) {
                case "en":
                    document.getElementById("header-lang-img").src =
                        "dashboard/images/flags/us.svg";
                    break;
                case "sp":
                    document.getElementById("header-lang-img").src =
                        "dashboard/images/flags/spain.svg";
                    break;
                case "gr":
                    document.getElementById("header-lang-img").src =
                        "dashboard/images/flags/germany.svg";
                    break;
                case "it":
                    document.getElementById("header-lang-img").src =
                        "dashboard/images/flags/italy.svg";
                    break;
                case "ru":
                    document.getElementById("header-lang-img").src =
                        "dashboard/images/flags/russia.svg";
                    break;
                case "ch":
                    document.getElementById("header-lang-img").src =
                        "dashboard/images/flags/china.svg";
                    break;
                case "fr":
                    document.getElementById("header-lang-img").src =
                        "dashboard/images/flags/french.svg";
                    break;
                case "ar":
                    document.getElementById("header-lang-img").src =
                        "dashboard/images/flags/ae.svg";
                    break;
                default:
            ...
            localStorage.setItem("language", e),
                null == (v = localStorage.getItem("language")) && h(E),
                (t = new XMLHttpRequest()).open(
                    "GET",
                    "dashboard/lang/" + v + ".json"
                ),
    ...
    function w() {
        ...
        e &&
            e.forEach(function (t) {
                const a = new bootstrap.Collapse(t, {
                    toggle: !1,
                });
    ...
    function S() {
        ...
        !t ||
            ...
            ((n = document.createElement("ul")).innerHTML =
                '<a href="index.html" class="logo"><img src="dashboard/images/logo-sm.png" alt="" height="22"></a>'),
            Array.from(
                document
    ...
    function I() {
        ...
        e < 1025 && 767 < e
            ...
            ? (document.body.classList.remove("twocolumn-panel"),
              ...
              "horizontal" == sessionStorage.getItem("data-layout") && q(),
              document.querySelector(".hamburger-icon") &&
                  document
                      .querySelector(".hamburger-icon")
                      .classList.remove("open"))
    ...
    function B() {
        ...
        Array.from(e).forEach(function (e) {
            e.addEventListener("click", N.bind(this), !1),
                e.addEventListener("mouseover", N.bind(this), !1);
        });
    }
    function N(e) {
        var t,
    ...
    function R(e) {
        if (e == e) {
            switch (e["data-layout"]) {
                case "vertical":
                    T("data-layout", "vertical"), x("vertical"), w();
                    break;
                case "horizontal":
                    T("data-layout", "horizontal"), x("horizontal");
                    break;
                case "twocolumn":
                    T("data-layout", "twocolumn"), x("twocolumn");
                    break;
                default:
            ...
            switch (e["data-topbar"]) {
                case "success":
                    T("data-topbar", "success");
                    break;
                case "danger":
                    T("data-topbar", "danger");
                    break;
                default:
                    T("data-topbar", "warning");
            }
    ...
    sessionStorage.getItem("defaultAttribute")
        ? ((a = {}),
          ...
          R(a))
        : ((c = document.documentElement.attributes),
          (a = {}),
        ...
        (c = document.querySelector('[data-toggle="fullscreen"]')) &&
            ...
            .forEach((a) => {
                a.addEventListener("click", (e) => {
                    ...
                    M.hasAttribute("data-bs-theme") && "auto" !== t
                        ? (J("data-bs-theme", t, "layout-mode-" + t, M),
    ...
    O(),
        (y = document.querySelectorAll(".counter-value")).length &&
            y.forEach((e) => {
                ...
                const o = () => {
                    (n += a) < t
                        ? ((e.innerText = P(n.toFixed(0))), setTimeout(o, 1))
                        : (e.innerText = P(t));
                };
                o();
            }),
        ...
        (d = document.getElementsByClassName("product")),
        y &&
            Array.from(y).forEach(function (e) {
                e.addEventListener("click", function (t) {
                    parseInt(e.previousElementSibling.value) <
                        ...
                        (t.target.previousElementSibling.value++, d) &&
            ...
            Array.from(b).forEach(function (e) {
                e.addEventListener("click", function (t) {
                    parseInt(e.nextElementSibling.value) >
                        ...
                        (t.target.nextElementSibling.value--, d) &&
                        Array.from(d).forEach(function (e) {
                            V(t.target);
                        });
                });
    ...
    window.addEventListener("resize", function () {
        H && clearTimeout(H), (H = setTimeout(Y, 2e3));
    });
})();
